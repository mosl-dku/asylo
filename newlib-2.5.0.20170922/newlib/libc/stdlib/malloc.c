...
#ifdef __ASYLO__
static void* (*malloc_hook)(size_t, void*) = NULL;
static void* malloc_pool = NULL;
static void (*free_hook)(void*, void*) = NULL;
static void* free_pool = NULL;

void
_DEFUN (set_malloc_hook, (custom_malloc, pool),
        void* (*custom_malloc)(size_t, void*) _AND
        void* pool)
{
  malloc_hook = custom_malloc;
  malloc_pool = pool;
}

void
_DEFUN (set_free_hook, (custom_free, pool),
        void (*custom_free)(void*, void*) _AND
        void *pool)
{
  free_hook = custom_free;
  free_pool = pool;
}
#endif  // __ASYLO__
	...
	size_t nbytes)		/* get a block */
{
  ...
  if (malloc_hook)
  {
    return malloc_hook(nbytes, malloc_pool);
  }
#endif  // __ASYLO__
