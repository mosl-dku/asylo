...
#ifdef _USE_MUSL_LIBM
#include <features.h>  // IWYU pragma: export
#endif
#include <sys/reent.h>
#include <sys/cdefs.h>
...
#if (!defined(_REENT_ONLY) && !defined(__math_68881)) || defined(_USE_MUSL_LIBM)
...
#endif /* (!__math_68881 && !_REENT_ONLY) || _USE_MUSL_LIBM */
...
#if !defined(__cplusplus) && !defined(_USE_MUSL_LIBM)
...
#if defined (_LDBL_EQ_DBL) || defined (__CYGWIN__) || defined(_USE_MUSL_LIBM)
/* Reentrant ANSI C functions.  */
#if !defined(__math_68881) || defined(_USE_MUSL_LIBM)
...
#endif /* ! defined (__math_68881) || defined(_USE_MUSL_LIBM) */
/* Non reentrant ANSI C functions.  */
#if (!defined(_REENT_ONLY) && !defined(__math_68881)) || defined(_USE_MUSL_LIBM)
...
#endif /* !defined (__math_68881) && !defined (_REENT_ONLY) */
...
#if !defined(_REENT_ONLY) || defined(_USE_MUSL_LIBM)
...
#endif /* ! defined (_REENT_ONLY) || defined(_USE_MUSL_LIBM) */
#else /* !_LDBL_EQ_DBL && !__CYGWIN__ && !defined(_USE_MUSL_LIBM) */
extern long double hypotl _PARAMS((long double, long double));
extern long double sqrtl _PARAMS((long double));
#ifdef __i386__
...
#if defined(__CYGWIN__) || defined(_USE_MUSL_LIBM)
extern void sincosl _PARAMS((long double, long double *, long double *));
#endif /* __CYGWIN__ || defined(_USE_MUSL_LIBM) */
# ifndef exp10
...
# endif
#endif /* defined(__CYGWIN__) || defined(_USE_MUSL_LIBM) */
#endif /* __GNU_VISIBLE */

#if __MISC_VISIBLE || __XSI_VISIBLE
/* The gamma functions use a global variable, signgam.  */
/* musl's libm.h declares __signgam and signgam differently. */
#if !defined(_USE_MUSL_LIBM) && !defined(_REENT_ONLY)
