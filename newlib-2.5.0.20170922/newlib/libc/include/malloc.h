...
#ifdef __ASYLO__
extern _VOID set_malloc_hook _PARAMS((_PTR(*)(size_t, _PTR), _PTR));
extern _VOID set_realloc_hook _PARAMS((_PTR(*)(_PTR, size_t, _PTR), _PTR));
extern _VOID set_free_hook _PARAMS((_VOID(*)(_PTR, _PTR), _PTR));
#endif  // __ASYLO__
