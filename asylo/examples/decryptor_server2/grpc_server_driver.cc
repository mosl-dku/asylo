...
#include "asylo/examples/decryptor_server2/grpc_server_util.h"
...
int main(int argc, char *argv[]) {
  ...
  status = examples::decryptor_server::LoadGrpcServerEnclave(
  ...
  asylo::StatusOr<int> port_result =
      examples::decryptor_server::GrpcServerEnclaveGetPort();
